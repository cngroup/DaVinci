...
//					"Input must have at least 3 points");
	 ...
	 * @return
	 */
	public static float[] intersect(float x1, float y1, float x2, float y2, float y) {
	...
	public static String[] wraplabel(String label, boolean bcut, boolean bwrap) {
		if(!bwrap) {
			if(bcut && label.length() > 15) {
