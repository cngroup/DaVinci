...
public interface IGraphListener<N> {

	public void setGraph(IGraph<N> graph);
	
	public IGraph<N> getGraph();
	
	public void nodeAdded(N node);
	
	public void nodeRemoved(N node);
	
	public void edgeAdded(IEdge<N> edge);
	
	public void edgeRemoved(IEdge<N> edge);
